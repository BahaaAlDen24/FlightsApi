...
class AirplanesController extends Controller
{
    ...
    {
        try{
            return response(Airplanes::all(),201)->header('Content-Type','text-plain') ;
        ...
        try{
            ...
            for ($i = 1 ; $i < 5 ;$i++){
                ...
                if ($files = $request->file('IMGSRC' . $i)) {
                    ...
                    $destinationPath = 'AirplanesFile/'; // upload path
            ...
            $MyObject = Airplanes::findOrFail($MyObject->id);
    ...
    public function show($id)
    {
        try {
            ...
            $MyObject = Airplanes::findOrFail($id);
